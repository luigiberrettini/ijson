...
def yajl_init(allow_comments=False, check_utf8=False):
    events = []
    ...
    # We need to pass callbacks back to avoid it destroy by GC what will cause
    # segfault.
    return handle, events, callbacks
